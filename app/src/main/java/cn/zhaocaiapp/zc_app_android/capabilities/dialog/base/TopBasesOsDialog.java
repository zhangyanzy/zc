package cn.zhaocaiapp.zc_app_android.capabilities.dialog.base;
...
public abstract class TopBasesOsDialog<T extends TopBasesOsDialog<T>> extends BottomTopBasesOsDialog {
    public TopBasesOsDialog(Context context, View animateView) {
        super(context);
    ...
    public TopBasesOsDialog(Context context) {
        this(context, null);
    }
