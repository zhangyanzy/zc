...
/**
 * 头部可伸缩的scrollView
 * 使用的时候需要放大的view是第一个RelativeLayout或者LinearLayout。
 * 且要加上 android:layout_gravity="center_horizontal"
 */
...
//        lp.height = (int) (dropZoomViewHeight * ((dropZoomViewWidth + s) / dropZoomViewWidth));
        lp.height = (int) (dropZoomViewHeight * ((dropZoomViewHeight + s) / dropZoomViewHeight));
