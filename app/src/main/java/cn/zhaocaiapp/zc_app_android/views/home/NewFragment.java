...
public class NewFragment extends BaseFragment implements OnRefreshListener, OnLoadmoreListener {
    ...
    @BindView(R.id.home_new_refresh)
    RefreshLayout home_new_refresh;
    ...
    @Override
    public void init() {
        home_new_recycler.setLayoutManager(new LinearLayoutManager(this.getActivity()));

        activityAdapter = new ActivityAdapter(this.getActivity(), activityRespList);
        home_new_recycler.setAdapter(activityAdapter);

        home_new_refresh.setOnRefreshListener(this);
        home_new_refresh.setOnLoadmoreListener(this);
    }
