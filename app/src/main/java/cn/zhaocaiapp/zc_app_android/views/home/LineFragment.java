...
public class LineFragment extends BaseFragment implements OnRefreshListener, OnLoadmoreListener {
    ...
    @BindView(R.id.home_line_refresh)
    RefreshLayout home_line_refresh;
    @BindView(R.id.home_line_recycler)
    RecyclerView home_line_recycler;
    ...
    @Override
    public void init() {
        home_line_recycler.setLayoutManager(new LinearLayoutManager(this.getActivity()));

        activityAdapter = new ActivityAdapter(this.getActivity(), activityRespList);
        home_line_recycler.setAdapter(activityAdapter);

        home_line_refresh.setOnRefreshListener(this);
        home_line_refresh.setOnLoadmoreListener(this);
    }
